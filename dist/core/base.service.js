...
let BaseService = class BaseService {
    ...
    async create(data) {
        try {
            ...
            throw new common_1.InternalServerErrorException('Error occurred while fetching data from MongoDB.', e);
        }
    }
...
exports.BaseService = BaseService = __decorate([
    ...
    (0, common_1.Catch)(typeorm_1.MongoError),
    __param(0, (0, mongoose_1.InjectModel)('model')),
